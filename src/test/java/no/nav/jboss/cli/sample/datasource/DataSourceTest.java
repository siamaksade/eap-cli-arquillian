package no.nav.jboss.cli.sample.datasource;

import static junit.framework.Assert.assertFalse;
import static no.nav.jboss.cli.sample.util.CliUtils.execute;
import static no.nav.jboss.cli.sample.util.CliUtils.isSuccess;
import static org.junit.Assert.assertTrue;

import java.io.File;
import java.util.List;

import no.nav.jboss.cli.sample.util.CliUtils;
